...
--local themes_path = beautiful.init(gears.filesystem.get_themes_dir() 
...
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/rainbow-custom"
theme.wallpaper=os.getenv("background")
if not theme.wallpaper then theme.wallpaper = theme.dir .. "/wall.png" end
