...
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/rainbow-custom/theme.lua")
...
xscreensaver_cmd = "xscreensaver-command -activate"
xscreensaver_lock_cmd = "xscreensaver-command -lock"
 ...
 awful.screen.connect_for_each_screen(function(s)
     ...
     s.mywibox:setup {
         ...
         { -- Right widgets
             ...
             spacerempty,
             wibox.layout.margin(tray,1,1,1),
             spacerempty,
             mytextclock,
             s.mylayoutbox,
         },
...
--fixed to not put empty tag in history
...
--awful.rules.rules.properties.size_hints_honor=false
-- }}}
